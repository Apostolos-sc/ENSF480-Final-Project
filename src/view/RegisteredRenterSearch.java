...
public class RegisteredRenterSearch extends JFrame implements ActionListener, MouseListener {
    ...
    public RegisteredRenterSearch(Frame parentFrame,Renter r) {
    ...
    public void setupGUI() {
       ...
       // passwordTextField = new JTextField("User's password", 18);
        ...
        priceTextField = new JTextField("Price...",9);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource().equals(searchButton)) {
        	if(this.isInteger(priceTextField.getText())) {
...
//        	System.out.println(noOfBed+" "+noOfBath+" "+furnish+" "+quadrantValue+" "+typeOfProperty);
        	...
        	searchingDatabase.addSearchedProperty(array, renter);
        	...
        	if(array.size()==0) {
        	 ...
        	 SearchPropertyGUI loginFrame = new SearchPropertyGUI(properties);
	          EventQueue.invokeLater(() -> {
            	...
            	JOptionPane.showMessageDialog(null, "Error in message input. Try Again!");
